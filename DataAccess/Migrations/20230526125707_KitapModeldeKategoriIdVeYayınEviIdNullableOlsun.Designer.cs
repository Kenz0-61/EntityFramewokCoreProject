...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230526125707_KitapModeldeKategoriIdVeYayınEviIdNullableOlsun")]
    partial class KitapModeldeKategoriIdVeYayınEviIdNullableOlsun
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModel.Models.FluentApi_Kitap", b =>
                {
            ...
            modelBuilder.Entity("DataModel.Models.FluentApi_KitapYazar", b =>
                {
            ...
            modelBuilder.Entity("DataModel.Models.FluentApi_YayinEvi", b =>
                {
                    b.Property<int>("YayinEvi_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("fluentApi_YayinEvleri");
                });

            modelBuilder.Entity("DataModel.Models.FluentApi_Yazar", b =>
                {
            ...
            modelBuilder.Entity("DataModel.Models.Kategori", b =>
                {
                    ...
                    b.ToTable("tbl_Kategori", (string)null);
                });
            ...
            modelBuilder.Entity("DataModel.Models.Kitap", b =>
                {
                    ...
                    b.HasIndex("KitapDetay_ID")
                        .IsUnique()
                        .HasFilter("[KitapDetay_ID] IS NOT NULL");
            ...
            modelBuilder.Entity("DataModel.Models.FluentApi_Kitap", b =>
                {
                    b.HasOne("DataModel.Models.FluentApi_KitapDetay", "KitapDetayEntity")
                        .WithOne("FluentApi_KitapEntity")
                        .HasForeignKey("DataModel.Models.FluentApi_Kitap", "KitapDetay_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataModel.Models.FluentApi_YayinEvi", "FluentApi_YayinEviEntity")
                        .WithMany("Fluent_Api_Kitap")
                        .HasForeignKey("YayinEvi_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FluentApi_YayinEviEntity");

                    b.Navigation("KitapDetayEntity");
                });

            modelBuilder.Entity("DataModel.Models.FluentApi_KitapYazar", b =>
                {
                    b.HasOne("DataModel.Models.FluentApi_Kitap", "FluentApi_Kitap")
                        .WithMany("FluentApi_KitapYazar")
                        .HasForeignKey("KitapID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataModel.Models.FluentApi_Yazar", "FluentApi_Yazar")
                        .WithMany("FluentApi_KitapYazar")
            ...
            modelBuilder.Entity("DataModel.Models.FluentApi_Kitap", b =>
                {
                    b.Navigation("FluentApi_KitapYazar");
                });

            modelBuilder.Entity("DataModel.Models.FluentApi_KitapDetay", b =>
                {
                    b.Navigation("FluentApi_KitapEntity")
                        .IsRequired();
                });

            modelBuilder.Entity("DataModel.Models.FluentApi_YayinEvi", b =>
                {
                    b.Navigation("Fluent_Api_Kitap");
                });
